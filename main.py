...
def home():
    if request.method == 'POST':
        ...
        evo_command = ["java", "-jar", "evosuite-1.0.6.jar", "-target", temp_file_path, "-criterion", "branch", f"-Dreport_dir={current_dir}", f"-Dtest_dir={current_dir}/tests", "-Dshow_progress=false"]
        # # if lib_provided:
