...
public class Tracks_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.Tracks"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Tracks_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.Tracks"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Tracks_ESTest_scaffolding.class.getClassLoader()); 
