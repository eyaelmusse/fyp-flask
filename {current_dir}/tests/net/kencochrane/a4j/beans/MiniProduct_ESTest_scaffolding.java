...
public class MiniProduct_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.MiniProduct"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MiniProduct_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.MiniProduct"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MiniProduct_ESTest_scaffolding.class.getClassLoader()); 
