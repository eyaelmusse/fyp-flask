...
public class SimilarProducts_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.SimilarProducts"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SimilarProducts_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.SimilarProducts"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SimilarProducts_ESTest_scaffolding.class.getClassLoader()); 
