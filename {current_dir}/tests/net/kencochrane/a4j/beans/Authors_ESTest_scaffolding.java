...
public class Authors_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.Authors"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Authors_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.Authors"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Authors_ESTest_scaffolding.class.getClassLoader()); 
