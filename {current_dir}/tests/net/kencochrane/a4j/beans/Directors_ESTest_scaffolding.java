...
public class Directors_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.Directors"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Directors_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.Directors"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Directors_ESTest_scaffolding.class.getClassLoader()); 
