...
public class Features_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.Features"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Features_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.Features"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Features_ESTest_scaffolding.class.getClassLoader()); 
