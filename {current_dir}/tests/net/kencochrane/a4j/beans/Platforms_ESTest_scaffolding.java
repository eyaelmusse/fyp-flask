...
public class Platforms_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.kencochrane.a4j.beans.Platforms"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Platforms_ESTest_scaffolding.class.getClassLoader() ,
      "net.kencochrane.a4j.beans.Platforms"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Platforms_ESTest_scaffolding.class.getClassLoader()); 
